...
bool WEB_MBA::FillWebDeck()
{
		return FillWebDeckAction();			
}

bool WEB_MBA::FillWebDeckAction()
{
	MISS;
...
void WEB_MBA::addCard(unsigned short uiCardID, bool Unit, bool Spell, bool Building)
{
	MISS;
...
bool WEB_MBA::getFromCSVBuilding(unsigned short uiCardID)
{
	for (unsigned int j = 0; j < Bro->L->CsvAllCards.size(); j++)
...
bool WEB_MBA::getFromCSVSpell(unsigned short uiCardID)
{
	for (unsigned int j = 0; j < Bro->L->CsvAllCards.size(); j++)
...
bool WEB_MBA::getFromCSVUnit(unsigned short uiCardID)
{
	for (unsigned int j = 0; j < Bro->L->CsvAllCards.size(); j++)

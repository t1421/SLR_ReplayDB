...
DBLIBS = -lcurl -ljsoncpp -lopencv_imgcodecs -lopencv_core -lopencv_imgproc -lopencv_highgui -lmysqlcppconn -lboost_filesystem
...
DB: SLR_ReplayDB.o BrokerDB.o DEBUG.o CardBaseDB.o Imager.o LOAD.o Manager.o PMV_to_SQL.o Reader.o Replay.o Thread_MIS.o Utility.o SQL_MIS_New.o
	$(CC) $(CFLAGS) -o DB SLR_ReplayDB.o BrokerDB.o DEBUG.o CardBaseDB.o Imager.o LOAD.o Manager.o PMV_to_SQL.o Reader.o Replay.o Thread_MIS.o Utility.o SQL_MIS_New.o $(DBLIBS) $(Const)
...
SLR_ReplayDB.o: SLR_ReplayDB.cpp Broker.h DEBUG.h SQL_MIS_New.h CardBase.h LOAD.h Manager.h Replay.h PMV_to_SQL.h Imager.h  Utility.h
	$(CC) -c SLR_ReplayDB.cpp -D BrokerNormal $(Const)
